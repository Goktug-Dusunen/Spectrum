...
class Terrain(object):
    ...
    def __init__(self):
        ...
        self.window.setWindowTitle('System')
        self.window.setGeometry(560, 70, 300, 50)
        self.window.setCameraPosition(distance=0.1, elevation=0.1)
        self.window.show()
    ...
    def mesh(self, offset=0, height=1.5, wf_data=None):
        ...
        for yid in range(self.nfaces - 22):
            yoff = yid * self.nfaces
            for xid in range(self.nfaces - 22):
                faces.append([
                    xid + yoff,
    ...
    def animation(self, frametime=1):
        """
